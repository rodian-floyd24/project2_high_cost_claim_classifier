const API_BASE_URL = window.PREDICTION_API_URL || "https://project2-high-cost-claim-classifier-api.onrender.com";
...
document.addEventListener("DOMContentLoaded", () => {
    const apiHealthLink = document.getElementById("api-health-link");
    if (apiHealthLink) {
        apiHealthLink.href = `${API_BASE_URL}/health`;
    }
    setupForm();
    fetchModelMetrics();
});
